...
./apigee-remote-service-cli provision --legacy --username $1 --password $2 --organization $3 --environment $4 > config.yaml
...
# Test end-to-end
curl -i http://localhost:8080/httpbin/headers -H "x-api-key: $5"